package it.toporowicz.domain.flightdata.adapters.cache

import it.toporowicz.domain.flightdata.ports.radarData.RadarData
import it.toporowicz.domain.flightdata.ports.cache.LastKnownRadarData
...
class RedisBasedFlightDataCache(private val jedisPool: JedisPool, private val objectMapper: ObjectMapper, private val clock: Clock) :
        FlightDataCache {
    ...
    override fun set(jobId: String, radarData: Set<RadarData>) {
        return jedisPool.resource.use { jedis ->
            ...
            jedis.set(RedisKey.forLastUpdate(jobId), clock.instant().toString())
        }
    }
